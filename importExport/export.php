<?php	
	...
	if (isset($_POST['exportOrganization']))
	{
		...
		//add the column headings to the .csv file
		fputcsv($output, array('Organization ID', 'Organization Name', 'Organization Type', 'First Name', 'Last Name', 'Position Title', 'Street Address', 'Street Address', 'City', 'State', 'Zip', 'Phone', 'Alternate Phone', 'Email', 'Number of Radios', 'How did they learn?', 'Signature', 'Date Signed'));
