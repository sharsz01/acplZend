        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" data-inputmask="'alias': 'mm/dd/yyyy'" class="form-control" name="radio-dateOfPurchase" id="radio-dateOfPurchase">
                </div>
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
...
<!-- Modal for saving changes for current Radios -->
<div class="modal fade" id="radioSaveModal" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content -->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Changes to Radios</h4>
            </div>
...
<!-- Modal for creating new Radio records -->
<div class="modal fade" id="newRadioModal" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content -->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">New Radio</h4>
            </div>
            <div class="modal-body">
                <p>New Radio Saved.</p>
            </div>
